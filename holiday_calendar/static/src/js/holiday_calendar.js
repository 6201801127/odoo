odoo.define('bsap_holiday_calendar.holiday_calendar', function(require) {
    "use strict";
    ...
    var HolidayCalendarView = AbstractAction.extend({
        ...
        init: function(parent, value) {
            ...
            this.calendar = ''
            if (value.tag == 'bsap_holiday_calendar.holiday_calendar') {
                var branch_id = 0
                var shift_id = 0
        ...
        render: function() {
            ...
            var kw_calendar = QWeb.render('bsap_holiday_calendar.holiday_calendar', {
                master_data: self,
            });
    ...
    core.action_registry.add('bsap_holiday_calendar.holiday_calendar', HolidayCalendarView);
