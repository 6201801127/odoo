...
class ContractAbstractContractLine(models.AbstractModel):
    ...
    last_date_invoiced = fields.Date(string="Last Date Invoiced", tracking=True)
    is_canceled = fields.Boolean(string="Canceled", default=False, tracking=True)
    is_auto_renew = fields.Boolean(string="Auto Renew", default=False, tracking=True)
    ...
    is_recurring_note = fields.Boolean(compute="_compute_is_recurring_note", tracking=True)
