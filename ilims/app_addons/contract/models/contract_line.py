...
class ContractLine(models.Model):
    ...
    is_plan_successor_allowed = fields.Boolean(
        string="Plan successor allowed?", compute="_compute_allowed", tracking=True
    )
    is_stop_plan_successor_allowed = fields.Boolean(
        string="Stop/Plan successor allowed?", compute="_compute_allowed", tracking=True
    )
    is_stop_allowed = fields.Boolean(string="Stop allowed?", compute="_compute_allowed", tracking=True)
    is_cancel_allowed = fields.Boolean(
        string="Cancel allowed?", compute="_compute_allowed", tracking=True
    )
    is_un_cancel_allowed = fields.Boolean(
        string="Un-Cancel allowed?", compute="_compute_allowed", tracking=True
    )
