...
class ContractRecurrencyMixin(models.AbstractModel):
    ...
    date_start = fields.Date(default=lambda self: fields.Date.context_today(self), tracking=True)
    recurring_next_date = fields.Date(
        compute="_compute_recurring_next_date", store=True, readonly=False, copy=True, tracking=True
    )
