...
class QcTriggerLine(models.AbstractModel):
    ...
    trigger = fields.Many2one(comodel_name="qc.trigger", required=True, tracking=True)
    test = fields.Many2one(comodel_name="qc.test", required=True, tracking=True)
...
class QcTriggerProductCategoryLine(models.Model):
    ...
    product_category = fields.Many2one(comodel_name="product.category", tracking=True)
...
class QcTriggerProductTemplateLine(models.Model):
    ...
    product_template = fields.Many2one(comodel_name="product.template", tracking=True)
...
class QcTriggerProductLine(models.Model):
    ...
    product = fields.Many2one(comodel_name="product.product", tracking=True)
