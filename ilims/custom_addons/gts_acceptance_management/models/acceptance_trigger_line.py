...
class AcceptanceTriggerLine(models.AbstractModel):
    _name = "acceptance.trigger.line"
    _description = "Abstract line for defining triggers"

    trigger = fields.Many2one(comodel_name="acceptance.trigger", required=True)
    test = fields.Many2one(comodel_name="acceptance.test", required=True)
...
class AcceptanceTriggerProductCategoryLine(models.Model):
    _inherit = "acceptance.trigger.line"
    _name = "acceptance.trigger.product_category_line"
    _description = "Acceptance Trigger Product Category Line"
    ...
    def get_trigger_line_for_product(self, trigger, product, partner=False):
        ...
        while category:
            for trigger_line in category.acceptance_triggers.filtered(
...
class AcceptanceTriggerProductTemplateLine(models.Model):
    _inherit = "acceptance.trigger.line"
    _name = "acceptance.trigger.product_template_line"
    _description = "Acceptance Trigger Product Template Line"
    ...
    def get_trigger_line_for_product(self, trigger, product, partner=False):
        ...
        for trigger_line in product.product_tmpl_id.acceptance_triggers.filtered(
            lambda r: r.trigger == trigger
            and (
                not r.partners
                or not partner
...
class AcceptanceTriggerProductLine(models.Model):
    _inherit = "acceptance.trigger.line"
    _name = "acceptance.trigger.product_line"
    _description = "Acceptance Trigger Product Line"
    ...
    def get_trigger_line_for_product(self, trigger, product, partner=False):
        ...
        for trigger_line in product.acceptance_triggers.filtered(
            lambda r: r.trigger == trigger
            and (
                not r.partners
                or not partner
