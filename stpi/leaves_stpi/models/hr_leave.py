...
class HrLeave(models.Model):
    ...
    address_during_leave = fields.Char(string="Address During Leave Period")
    ...
    def joining_date_leave_apply_validation(self):
        for record in self:
            if record.date_from.date() < record.employee_id.date_of_join:
...
## Nikunja - Aug 23 2021
    ...
    def _onchange_leave_dates(self):
        print("Number of daysssssssssssssqqqqqqqqqssssssssss")
        days = 0.0
    ...
    def action_refuse(self):
        ...
        for leave in self:
            ...
            if leave.cancel_req == False and leave.state == 'validate':
                raise ValidationError(_("You are not allowed to cancel any leave uptill the cancellation request is not send."))
