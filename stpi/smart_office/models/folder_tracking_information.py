...
class FolderTrackingInformation(models.Model):
    ...
    forwarded_by = fields.Many2one('res.users', string='Forwarded From', readonly=True)
    ...
    job_post_id = fields.Many2one('stpi.job.post', 'Functional Designation', readonly=True)
