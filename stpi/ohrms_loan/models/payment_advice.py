...
class PaymentAdvices(models.Model):
    _name = 'loan.payment.advice'
    _description = 'Loan Payment Advices'
    ...
    line_ids = fields.One2many('loan.payment.advice.line', 'advice_id', 
...
class PaymentAdvicesLine(models.Model):
    _name = 'loan.payment.advice.line'
    _description = 'Loan Payment Advice Lines'
    ...
    advice_id = fields.Many2one('loan.payment.advice', 'Payment Advice')