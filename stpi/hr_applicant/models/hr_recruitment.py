...
class ApplicantContractDocument(models.Model):
    _name = "applicant.contract.documents"
    _description = "Applicant Contract Documents"
...
class Applicant(models.Model):
    ...
    contract_document_ids = fields.One2many('applicant.contract.documents','applicant_id',string="Upload Contract Documents")
...
class ApplicantEducation(models.Model):
    ...
    grade = fields.Char('Degree')
    field = fields.Char(string='Exam Passed', size=128)
    stream = fields.Char("Stream/Discipline")
    school_name = fields.Char(string='University/Board', size=256)
