...
class OrientationChecklist(models.Model):
    ...
    checklist_name = fields.Char(string='Name /नाम', required=True)
    checklist_department = fields.Many2one('hr.department', string='Department /विभाग', required=True)
    ...
    checklist_line_id = fields.Many2many('checklist.line', 'checklist_line_rel', String="Checklist /जांच सूची")
