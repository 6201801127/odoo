...
#                                 ],required=True)
    ...
    def get_name(self):
        for leave in self:
            ...
            if leave.leave_type.code in ["Half Pay Leave", "Maternity Leave", "Earned Leave", "Restricted Holiday", "Child Care Leave"]:
                leave.is_half_pay = True
            else:
                leave.is_half_pay = False
