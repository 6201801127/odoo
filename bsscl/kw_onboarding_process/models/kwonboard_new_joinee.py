...
class kwonboard_new_joinee(models.Model):
    ...
    practise_id = fields.Many2one('hr.department', string="Practice", domain=[('dept_type.code', '=', 'practise')])
    ...
    need_sync = fields.Boolean(string="Create in Kwantify?")
    ...
    def create_employee_user(self):
        ...
        for rec in self:
            ...
            if rec.direct_indirect != '2':
                ...
                post_rec_vals['kw_id_generation'] = 'yes' if need_sync == True else 'no'
