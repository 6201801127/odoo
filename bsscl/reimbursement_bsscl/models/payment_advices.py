...
class PaymentAdvices(models.Model):
    _name = 'reimbursement.payment.advice'
    _description = 'Reimbursement Payment Advices'
    ...
    line_ids = fields.One2many('reimbursement.payment.advice.line', 'advice_id',
...
class PaymentAdvicesLine(models.Model):
    _name = 'reimbursement.payment.advice.line'
    _description = 'Reimbursement Payment Advice Lines'
    ...
    advice_id = fields.Many2one('reimbursement.payment.advice', 'Payment Advice')
