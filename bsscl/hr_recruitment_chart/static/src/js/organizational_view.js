odoo.define('hr_recruitment_chart.view_chart', function (require){
"use strict";
...
var EmployeeOrganizationalChart =  AbstractAction.extend({
    ...
    contentTemplate: 'RecruitmentEmployeeChart',
    events: {
        'click img': '_getChild_data',
       // 'click .employee_name': '_getChild_data',
    },
    ...
    renderEmployeeDetails: function (){
        ...
        var self = this;
        this._rpc({
            route: '/get/recruitment/job',
        }).then(function (result) {
            self.parent_len = result[1];
            $.ajax({
                url: '/get/recruitjob/opening',
                type: 'POST',
    ...
    core.action_registry.add('recruitment_dashboard', EmployeeOrganizationalChart);
