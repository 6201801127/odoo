...
var PreviewContentCSV = AbstractPreviewContent.extend({
	...
	cssLibs: [
		'/kw_dms_preview/static/csv_preview/lib/pikaday/pikaday.css',
		'/kw_dms_preview/static/csv_preview/lib/handsontable/handsontable.css',
    ],
    jsLibs: [
        '/kw_dms_preview/static/csv_preview/lib/papaparse/papaparse.js',
        '/kw_dms_preview/static/csv_preview/lib/numbro/numbro.js',
        '/kw_dms_preview/static/csv_preview/lib/pikaday/pikaday.js',
        '/kw_dms_preview/static/csv_preview/lib/handsontable/handsontable.js',
    ],
    willStart: function() { 
		var def = $.Deferred();
