...
var PreviewContentText = AbstractPreviewContent.extend({
	...
	cssLibs: [
		'/kw_dms_preview/static/text_preview/lib/highlight/styles/default.css',
    ],
    jsLibs: [
        '/kw_dms_preview/static/text_preview/lib/highlight/highlight.pack.js',
        '/kw_dms_preview/static/text_preview/lib/highlight_line_numbers/highlight_line_numbers.js',
    ],
	willStart: function() { 
		var def = $.ajax({
		  url: this.url,
