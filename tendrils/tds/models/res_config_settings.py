...
class ResConfigSettings(models.TransientModel):
    ...
    tds_company_id = fields.Many2one('res.company')
    ...
    def set_values(self):
        ...
        field13 = self.tds_company_id.id or False
        ...
        param.set_param('tds.tds_company_id', field13)
    ...
    def get_values(self):
        ...
        res.update(
            ...
            tds_company_id = int(self.env['ir.config_parameter'].sudo().get_param('tds.tds_company_id'))
        )
