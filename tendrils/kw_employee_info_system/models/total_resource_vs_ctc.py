...
class TotalResourcs(models.Model):
    _name = "hr.mis.total.resource.vs.ctc"
    _description = "total resource vs ctc"
    ...
    @api.depends('april_employee_count','may_employee_count','june_employee_count','july_employee_count', 'aug_employee_count','sept_employee_count','oct_employee_count','nov_employee_count','dec_employee_count',
    ...
    @api.depends('april_ctc','may_ctc','june_ctc','july_ctc','aug_ctc','sept_ctc','oct_ctc','nov_ctc','dec_ctc','jan_ctc','feb_ctc','march_ctc')
