...
class AnnualCapitalDraftBudgetvsActual(models.Model):
    _name = "annual_capital_draft_budget_vs_actual"
    _description = "Annual Budget For four year of expense draft budget"
    _auto = False
