...
class AnnualRevenueBudgetvsActual(models.Model):
    _name = "annual_revenue_budget_vs_actual"
    _description = "Annual Budget For three year of expense Revenue budget"
    _auto = False
        ...
        self.env.cr.execute(f""" CREATE or REPLACE VIEW %s as (
           with final as (With final_cte as (WITH a AS (
            ...
            left JOIN
                ...
                where kl.account_code_id IS NOT NULL  and ks.state ='validate' and kl.state ='validate'
            GROUP BY
                kl.account_code_id,
                ks.fiscal_year_id,
                kl.project_id,
