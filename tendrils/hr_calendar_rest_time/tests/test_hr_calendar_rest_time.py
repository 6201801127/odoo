...
"""
Module: Test Utilities for Odoo Models

Summary:
    This module provides utilities for testing Odoo models.

Description:
    The module contains common testing functionality used for Odoo models. It includes utilities
    for transactions, field definitions, exception handling, and datetime manipulation.
...
class HRCalendarRestTime(TransactionCase):
    """
    Test case class for managing rest times in HR calendars.

    This class provides test cases for ensuring proper functionality of rest times
    within HR calendars. It extends the TransactionCase class provided by Odoo's testing framework.
