odoo.define('kw_onboarding.kwonboard_personal_details', function (require) { 
    'use strict';
    var personal = {
        current_id:'',
        clone:'',
        ...
        validation: function(){
            ...
            $("form#frm_personal_data").validate({
                ...
                rules: {
                    ...
                    ddlMotherTounge: {selectListItem: "0"},
                ...
                messages: {
                    ...
                    ddlMotherTounge:{selectListItem: "Please select your mothertounge"},
                    ...
                    txtFatherName: "Please provide your Father name ", 
                    txtFatherDob: "Please provide your father's date of birth ",
                    txtMotherName: "Please provide your Mother name " , 
