odoo.define('kw_onboarding.kwonboard_intermediate_view', function (require) {  // how it works ??
    'use strict';
    ...
    $(function () {
            $('#btnSubmitMobile').on('click',function(){
                ...
                var get_mobile2 = find_mob.substring(7,10);
                    ...
                    else
                    {
                        ...
                        ajax.jsonRpc("/getmaxtries_onboarding", 'call', {'user_input_mobile' :find_mob ,})
                            .then(function (values) {
            ...
            $('#btnSubmit').on('click',function(){
                ...
                enroll.showLoading();
                var ajax = require('web.ajax');
                ajax.jsonRpc("/searchOTP", 'call', {'otp':encrypted.toString()})
                    .then(function (values) {
                        enroll.hideLoading();
                        // alert(values)
            ...
            $('#resendotp').on('click',function(){
                ...
                ajax.jsonRpc("/searchMobNo", 'call', {'user_input_mobile' :find_mob})
                    .then(function (values) {
                        // console.log('vales onboard===',values)
                        // alert(values)
                        var get_email = values
                        if(!values )
                        {
