...
class Personaldetails:
    ...
    def getPersonaldetailsfromDB(self, enrollment_data):
        ...
        if enrollment_data:
            ...
            personaldict['ddlBloodGroup'] = enrollment_data.blood_group.id if enrollment_data.blood_group else ""
            ...
            # personaldict['submit_edu_work'] = enrollment_data.applicant_id.submit_edu_work if enrollment_data.applicant_id.submit_edu_work is True else False
    ...
    def savePersonalInfo(self, enrollment_data, **kw):
        ...
        try:
            ...
            birthday_new_string = f'{slist[2]}-{slist[1]}-{slist[0]}'

            if kw['txtWedAniversary']:
                wedding_annv_string = kw['txtWedAniversary']
                sp_list = wedding_annv_string.split("-")
                wedding_annv_new_string = f'{sp_list[2]}-{sp_list[1]}-{sp_list[0]}'
