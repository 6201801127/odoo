...
class kw_announcement_groups(models.Model):
    _name = 'kw_announcement_groups'
    _description = 'Announcement Groups'
    ...
    def _add_magic_fields(self):
        super(kw_announcement_groups, self)._add_magic_fields()
    ...
    def default_get(self, fields_list):
        res = super(kw_announcement_groups, self).default_get(fields_list)
        # print('res => ', res)
