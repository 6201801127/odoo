    ...
    var FieldOrgChart = AbstractField.extend({
        ...
        _getOrgData: function (employee_id) {
            ...
            return this.dm.add(this._rpc({
                ...
                self.orgData = data;
                // console.log("in orgdata=======================",self.orgData)
            });
        },
        /**
         * @override
        ...
        _onEmployeeSubRedirect: function (event) {
            ...
            var domain = [['parent_id', '=', employee_id],['employement_type.code','!=','O']];
            var name = _.str.sprintf(_t("Direct Subordinates of %s"), employee_name);
            // console.log("in emp subordinate===================================",type)
            if (type === 'total') {
                domain = ['&','&', ['parent_id', 'child_of', employee_id], ['id', '!=', employee_id],['employement_type.code','!=','O']];
                // console.log("in if subordinate======total====================")
                name = _.str.sprintf(_t("Subordinates of %s"), employee_name);
            } else if (type === 'indirect') {
                domain = ['&', '&','&',
                    ['parent_id', 'child_of', employee_id],['employement_type.code','!=','O'],
                    ['parent_id', '!=', employee_id],
                    ['id', '!=', employee_id]
                ];
                // console.log("in elif subordinate=======indirect===================")
