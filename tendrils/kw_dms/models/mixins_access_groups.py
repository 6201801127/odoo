...
class AccessGroupsModel(models.AbstractModel):
    ...
    _name = 'kw_dms_security.mixins.access_groups'
    _description = "Group Access Mixin"
    _inherit = 'kw_dms_security.mixins.access_rights'
    ...
    def _add_magic_fields(self):
        ...
        add('groups', fields.Many2many(
            ...
            comodel_name='kw_dms_security.access_groups',
    ...
    def _apply_access_groups(self, query, mode='read'):
        ...
        where_clause = '''
            "{table}".id IN ( 
                ...
                JOIN kw_dms_security_access_groups g ON r.gid = g.id 
                JOIN kw_dms_security_access_groups_users_rel u ON r.gid = u.gid 
