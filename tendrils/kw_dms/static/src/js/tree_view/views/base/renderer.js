...
odoo.define('kw_dms_view.DocumentsRenderer', function(require) {
"use strict";
...
var DocumentsRenderer = Widget.extend(dropzone.FileDropzoneMixin, {
	xmlDependencies: [
		'/kw_dms/static/src/xml/tree_view/tree.xml'
	],
	cssLibs: [
        '/kw_dms/static/lib/jsTree/themes/proton/style.css',
    ],
    jsLibs: [
        '/kw_dms/static/lib/jsTree/jstree.js',
    ],
    ...
    start: function() {
    	...
    	this.$tree.on('open_node.jstree', function (e, data) {
    		if(data.node.data && data.node.data.odoo_model === "kw_dms.directory") {
