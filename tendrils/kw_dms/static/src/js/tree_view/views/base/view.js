...
odoo.define('kw_dms_view.DocumentTreeView', function(require) {
"use strict";
...
var DocumentsModel = require('kw_dms_view.DocumentsModel');
var DocumentsRenderer = require('kw_dms_view.DocumentsRenderer');
var DocumentsController = require('kw_dms_view.DocumentsController');
