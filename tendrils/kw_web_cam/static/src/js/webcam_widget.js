...
*/
odoo.define('kw_web_cam.webcam_widget', function(require) {
    "use strict";
    ...
    imageWidget.include({
        ...
        _render: function () {
            ...
            Webcam.set({
                ...
                force_flash: false,
                fps: 45,
                swfURL: '/kw_web_cam/static/src/js/webcam.swf',
                //force_flash: true,
            });
...
/*            new Model('ir.config_parameter').call('get_param', ['web_widget_image_webcam.flash_fallback_mode', false]).
            ...
            self.$el.find('.o_form_binary_file_web_cam').off().on('click', function(){
                ...
                // WebCamDialog.find("#webcam_result").html('<img src="/kw_web_cam/static/src/img/webcam_placeholder.png"/>');
            });
        },
    });
