odoo.define('kw_sale.team_target_plan', function (require) {
    "use strict";
    ...
    var TeamTargetPlan = AbstractAction.extend(ControlPanelMixin, {
...
//            console.log('compute_budget');
    ...
    core.action_registry.add('kw_sale.company_target_plan', TeamTargetPlan);

    return TeamTargetPlan
    });
