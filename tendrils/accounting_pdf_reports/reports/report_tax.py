# -*- coding: utf-8 -*-
"""
This module contains an abstract model for generating tax reports in Odoo.

It includes functionalities for handling time-related operations, user errors,
and abstract models for tax reporting.
...
class ReportTax(models.AbstractModel):
    """
    This abstract model represents a tax report in Odoo.
    
    """
    _name = 'report.accounting_pdf_reports.report_tax'
    _description = "Accounting pdf tax"
