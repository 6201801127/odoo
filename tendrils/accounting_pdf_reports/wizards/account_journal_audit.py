# -*- coding: utf-8 -*-
"""
This module contains a transient model for printing journal reports in Odoo.
...
class AccountPrintJournal(models.TransientModel):
    """
    This transient model represents a wizard for printing journal reports in Odoo.
    """
