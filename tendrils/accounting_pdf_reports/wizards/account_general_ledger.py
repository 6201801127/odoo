# -*- coding: utf-8 -*-
"""
This module contains a transient model for generating general ledger reports in Odoo.

It includes functionalities for defining transient models using fields, models, and raising user errors.
...
class AccountReportGeneralLedger(models.TransientModel):
    """
    This transient model represents a wizard for generating general ledger reports in Odoo.
    """
