...
class kw_adv_pre_closer_wizard(models.TransientModel):
    ...
    paid_installment = fields.Integer(string="Paid Installment", compute='_get_installment_data')
    paid_amount = fields.Float(string="Paid Amount", compute='_get_installment_data')
    left_installment = fields.Integer(string="Remaining Installment", compute='_get_installment_data', store=True)
    left_amount = fields.Float(string="Remaining Amount", compute='_get_installment_data')
