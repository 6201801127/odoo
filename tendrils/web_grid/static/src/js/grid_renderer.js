            ...
            return h('tr', {key: rowKey}, [
                h('th', {}, [
                    h('div', _.map(rowValues, function (label) {
                        var klass = label !== _t('') ? '' : 'o_grid_text_muted';
                    ...
                    h('tr', [
                        ...
                        _(columns).map(function (column, column_index) {
                            return h('td', {class: {
                                ...
                                o_grid_holiday: column.is_holiday,
                                o_grid_week_off: column.is_week_off,
                                o_grid_leave: column.is_leave,
                    ...
                    h('tr', [
                        ...
                        _.map(columns, function (column) {
                            return h('th', {
                                ...
                                attrs:{
                                    'title': column.is_holiday ? 'Holiday: '+column.is_holiday_name : (column.is_leave ? 'Leave' : (column.is_week_off ? 'Week Off' : (column.is_current ? 'Today' : '')))
                                    // 'title': column.is_current ? 'Today' : ''
                                }
                            },
