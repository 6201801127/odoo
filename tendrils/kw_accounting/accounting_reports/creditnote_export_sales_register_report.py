...
class CreditNoteExportSalesRegisterReport(models.Model):
    _name = "creditnote.export.sales.register.report"
    _description = "Credit Note Export Sales Register Report"
    _auto = False
    ...
    def init(self):
        ...
        query = f""" CREATE or REPLACE VIEW {self._table} as (
            ...
            where rp.business_operation = '2' and ai.type= 'out_refund'
