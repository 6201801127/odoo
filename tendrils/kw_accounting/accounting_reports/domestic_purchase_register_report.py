...
class DomesticPurchaseRegisterReport(models.Model):
    _name = "domestic.purchase.register.report"
    _description = "Domestic Purchase Register Report"
    _auto = False
    ...
    def init(self):
        ...
        query = f""" CREATE or REPLACE VIEW {self._table} as (
            ...
            where rp.business_operation = '1' and ai.type= 'in_invoice'
