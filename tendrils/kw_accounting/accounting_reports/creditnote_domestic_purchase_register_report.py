...
class CreditNoteDomesticPurchaseRegisterReport(models.Model):
    _name = "creditnote.domestic.purchase.register.report"
    _description = "Credit Note Domestic purchase Register Report"
    _auto = False
    ...
    def init(self):
        ...
        query = f""" CREATE or REPLACE VIEW {self._table} as (
            ...
            where rp.business_operation = '1' and ai.type= 'in_refund'
