...
class CreditNoteDomesticSalesRegisterReport(models.Model):
    _name = "creditnote.domestic.sales.register.report"
    _description = "Credit Note Domestic Sales Register Report"
    _auto = False
    ...
    def init(self):
        ...
        query = f""" CREATE or REPLACE VIEW {self._table} as (
            ...
            where rp.business_operation = '1' and ai.type= 'out_refund'
