...
class ExportPurchaseRegisterReport(models.Model):
    _name = "export.purchase.register.report"
    _description = "Export Purchase Register Report"
    _auto = False
    ...
    def init(self):
        ...
        query = f""" CREATE or REPLACE VIEW {self._table} as (
            ...
            where rp.business_operation = '2' and ai.type= 'in_invoice'
