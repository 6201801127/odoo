...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'kw_accounting.template_followup_report'
        templates['line_template'] = 'kw_accounting.line_template_followup_report'
        return templates
    ...
    def print_followups(self, records):
        ...
        return self.env.ref('kw_accounting.action_report_followup').report_action(res_ids)
