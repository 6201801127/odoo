...
var accountReportsWidget = AbstractAction.extend(ControlPanelMixin, {
    ...
    filter_accounts: function(e) {
        ...
        this.$('.o_account_reports_level2').each(function(index, el) {
            // console.log($(el).find('data-parent-id'))
            ...
            // console.log(' >>>> ', lineText, query, lineText.toLowerCase().indexOf(query))
            var queryFound = lineText.toLowerCase().indexOf(query)  > -1 ? true : false;
            //var queryFound = lineText.split(' ').some(function (str) {
                // console.log('str >>>> ',lineText, str, query);
                //console.log(' >>>> ', str, query, str.indexOf(query))
                //return str.indexOf(query) > -1 ? true : false;
                // return query.split(' ').some(function (key) {
                //     console.log('key >>> ',key, str.toLowerCase().startsWith(key));
                //     return str.toLowerCase().startsWith(key);
                // });
