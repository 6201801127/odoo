odoo.define('kw_accounting.advance_vs_payment_report', function (require) {
    "use strict";
    ...
    var AdvanceVsPaymentReport = AbstractAction.extend(ControlPanelMixin, {
        ...
        init: function(parent, context) {
            ...
            var self = this;
            if (context.tag == 'kw_accounting.advance_vs_payment_report') {
                self._rpc({
                    model: 'account.account',
                    method: 'advance_vs_payment_report',
        ...
        render: function() {
            ...
            var self = this;
            var advance_vs_payment_page = QWeb.render( 'kw_accounting.advance_vs_payment', {
                widget: self,
            });
    ...
    core.action_registry.add('kw_accounting.advance_vs_payment_report', AdvanceVsPaymentReport);
